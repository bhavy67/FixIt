...
function post(message: WorkerMessage<ImageToPdfWorkerResult>, transfer?: Transferable[]): void {
...
ctx.addEventListener('message', async (e: MessageEvent<ImageToPdfWorkerInput>) => {
  try {
