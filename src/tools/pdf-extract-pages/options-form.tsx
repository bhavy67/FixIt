...
export function PdfExtractOptionsForm({ value, onChange }: OptionsFormProps<PdfExtractOptions>) {
  const pagesId = useId();
    ...
    <div className="border-border bg-card flex flex-col gap-4 rounded-xl border p-4">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-muted-foreground text-xs">
          Separate pages with commas. Use ranges like 2-5. Leave blank to keep all.
        </p>
      </div>
    </div>
  );
